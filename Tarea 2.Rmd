...
gastos %>%
  ggplot(aes(Edad_aÃ.os, fill = Sexo)) + #uso fill porque me gusta que el grafico tenga color
  geom_bar() +
  facet_wrap( ~ Sexo) +
...
gastos %>%
  ggplot(aes(Edad_aÃ.os, Importe, colour = Sexo)) + #uso colour porque me gusta  el gráfico con colores
  geom_point() +
  facet_wrap( ~ Sexo) +
